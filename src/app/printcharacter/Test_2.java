package app.printcharacter;//Program By SMB Corporation written in SMB Corporation Text Editor

//The program is Huge, it wll take time to complete.
...
System.out.println("\n\n----------------------------------------------\nLooping Successfull\n");
Test_2.main(args);//calling main function
}
}