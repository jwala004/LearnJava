...
//		MergeTwoArrays.mergeTwoArrays();
    ...
    private static void mergeTwoArraysWthOutUsngInbuiltFunc() {
        ...
        // determining length of the first array
        int a1 = a.length;
        // determining length of the second array
        int b1 = b.length;
        ...
        // Loop to store the elements of the first
        // array into a resultant array
        for (int i = 0; i < a1; i++) {
        ...
        // Loop to concat the elements of the second
        // array into a resultant array
        for (int i = 0; i < b1; i++) {
